      ...
      <div className="  flex lg:flex-row lg:gap-x-6 flex-col space-y-6">
        ...
        <div className="basis-1/2 flex flex-col space-y-4 pt-6">
          <div className="flex flex-col space-y-3">
            ...
            <h2 className="text-2xl max-w-3xl font-bold md:text-3xl    lg:text-4xl bg-gradient-to-r flex  from-star_color_2 to-star_color_1 bg-clip-text text-transparent">
              {colorTitle}
            </h2>
          </div>
